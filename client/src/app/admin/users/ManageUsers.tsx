...
export function ManageUsers() {
	const { users, deleteUser, isPending, setPage, searchTerm, setSearchTerm, isHasMore } =
		useManageUsersQuery()
	...
	return (
		<div className='mt-5'>
				...
				<DashboardTable<IUsersTable>
					...
					columns={[
						...
						},
						{
							...
							dataIndex: 'avatarUrl',
							render: record =>
								record.avatarUrl && <Image alt='' src={record.avatarUrl} width={50} height={50} />
						},
						{
							title: 'Email',
							dataIndex: 'email',
			...
			{isHasMore && <ManageUsersShowMore setPage={setPage} loading={isPending} />}
		</div>
	)
}
